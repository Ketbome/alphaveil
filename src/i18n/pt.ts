...
export const pt: Dict = {
  ...
  retouch: {
    ...
    selectFailed: 'Não foi possível calcular a seleção. Mude para outra ferramenta e volte para Clique no objeto para carregar o modelo de novo.',
    shape: 'Forma',
